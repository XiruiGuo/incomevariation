...
## fm_ern to fm_ern_new

step1: delete non-data rows
step2: rename the colname
step3: substring the length of Year to 4
step4: We observe that "2013" and "2017" appear twice 
       according to the annotate of the original data
       We choose the first row data of "2013" and "2017" 
step5: delete non-useful columns "MOE1","MOE2","MOE3","MOE4"
step6: missing value will be dealed with in Missing value part
...
## house_67_20 to house_67_20_new

step1: delete non-correlative rows
step2: rename the colname
step3: delete un-useful row and add a categorical variable of race
